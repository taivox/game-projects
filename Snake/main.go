...
// 2. Print an error message id the screen size is not big enough
// 3. Print the score in real life
...
// 8*. Make a variant of the game where the snake reappears at the other end of the screen if it hits the wall
