...
//		Insted keep track of scores,
//		reset the game after someone scores and "game over"
//		once someone reaches score of 5.
//		For this challenge you will have to run your game inside an explicit
//		frame on the screen instead of always running it full screen.
...
func initGameState() {
	...
	player1Paddle = &GameObject{
		row: paddleStart, col: 0, width: 1, height: PaddleHeight, velRow: 0, velCol: 0, symbol: PaddleSymbol,
	}
	player2Paddle = &GameObject{
		row: paddleStart, col: width - 1, width: 1, height: PaddleHeight, velRow: 0, velCol: 0, symbol: PaddleSymbol,
	}
	ball = &GameObject{
		row: height / 2, col: width / 2, width: 1, height: 1, velRow: InitialBallVelocityRow, velCol: InitialBallVelocityCol, symbol: BallSymbol,
	}
	gameObjects = []*GameObject{
